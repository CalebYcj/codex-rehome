...
export function prepareSupport(source: SupportSource, locale: "zh-CN" | "en", userNote?: string): Promise<SupportPreview> {
  return invoke("prepare_support", { selection: { source, locale, user_note: userNote ?? null } });
}
